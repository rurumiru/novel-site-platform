...
<div class="eri-section" style="min-height:100vh;display:flex;align-items:center;justify-content:center;text-align:center;">
    <div style="max-width:480px;">
        ...
        <h1 style="font-family:var(--display);font-size:32px;font-weight:500;letter-spacing:-0.02em;color:var(--text);margin:0 0 14px;">Доступ ограничен</h1>
        <p style="font-family:var(--serif);font-size:17px;line-height:1.55;color:var(--text-3);margin:0 0 32px;">Этот контент недоступен в вашем регионе.</p>
