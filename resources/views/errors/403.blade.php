...
<div class="eri-section" style="min-height:100vh;display:flex;align-items:center;justify-content:center;text-align:center;">
    <div style="max-width:480px;">
        <div style="font-family:var(--display);font-size:clamp(120px,22vw,220px);font-weight:500;line-height:1;letter-spacing:-0.04em;color:var(--text-faint);margin-bottom:8px;">403</div>
        <h1 style="font-family:var(--display);font-size:32px;font-weight:500;letter-spacing:-0.02em;color:var(--text);margin:0 0 14px;">Доступ запрещён</h1>
        <p style="font-family:var(--serif);font-size:17px;line-height:1.55;color:var(--text-3);margin:0 0 32px;">У вас нет прав для просмотра этой страницы.</p>
